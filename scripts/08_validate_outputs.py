...
REQUIRED_TABLE_COLUMNS = {
    ...
    "signature_contrast_sensitivity.csv": {"cell_type_clean", "signature", "contrast", "original_delta_mean", "z_score_delta", "rank_percentile_delta"},
    "signature_score_method_correlations.csv": {"cell_type_clean", "signature", "n_sample_profiles", "pearson_mean_vs_z", "spearman_mean_vs_rank"},
