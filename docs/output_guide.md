...
5. `docs/figures/top_subtypes_by_tissue.png` and subtype heatmaps for cell-state context.
6. `notebooks/01_dataset_overview.ipynb` for interactive table inspection.
